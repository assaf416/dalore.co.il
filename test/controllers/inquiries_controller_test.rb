...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { email: @inquiry.email, message: @inquiry.message, name: @inquiry.name, phone_no: @inquiry.phone_no } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { email: @inquiry.email, message: @inquiry.message, name: @inquiry.name, phone_no: @inquiry.phone_no } }
